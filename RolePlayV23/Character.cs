...
public class Character
{
    ...
    private int ReceiveDamageModify(int receivedDamage)
    {
        ...
        if (NumberGenerator.BelowPercentage(ReceiveDamageModifyChance))
        {
            ...
            Console.WriteLine("damage taken as defender");
            Console.ForegroundColor = ConsoleColor.White;
            // ------------------- 
            return modifiedReceivedDamage = CalculateModifiedReceivedDamage(receivedDamage);
        ...
        else
        {
            ...
            Console.WriteLine("Original damage");
            Console.ForegroundColor = ConsoleColor.White;
            // -------------------
